...
public class TransferServiceImpl implements  TransferService {
    ...
    public TransferServiceImpl(UserDao userDao, TransferDao transferDao) {
        this.userDao = userDao;
        this.transferDao = transferDao;
    }

    // Allows a logged in user to send a transfer from their account
    public boolean sendTransfer(Transfer transfer, Principal principal) throws SQLException, UserNotFoundException, InsufficientBalanceException {
        // Validate transfer
    ...
    public boolean requestTransfer(Transfer transfer, Principal principal) throws SQLException, UserNotFoundException, InsufficientBalanceException {
        if (!(validateTransfer(transfer, principal))) {
            return false;
        }
